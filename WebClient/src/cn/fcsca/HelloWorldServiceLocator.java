...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements cn.fcsca.HelloWorldService {
    ...
    public cn.fcsca.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public cn.fcsca.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.fcsca.HelloWorldSoapBindingStub _stub = new cn.fcsca.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.fcsca.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.fcsca.HelloWorldSoapBindingStub _stub = new cn.fcsca.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
